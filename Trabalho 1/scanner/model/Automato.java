...
public class Automato {
    ...
    public Set<Integer> estadosFinais = new HashSet<>();
    public Map<Integer, String> mapeamentoTokens = new HashMap<>();
    public Map<Integer, Map<String, List<Integer>>> transicoes = new HashMap<>();
    public Map<Integer, String> anotacaoDeEstados = new HashMap<>();
    public Map<Integer, List<String>> finalStateTipos = new HashMap<>();
    public Map<String, Integer> tipoPriority = new HashMap<>();
    public String tipo;
    ...
    public void addTransicao(int origem, String simbolo, int destino) {
        transicoes
    ...
    public void addFinalStateTipo(int estado, String tipo) {
    ...
    public void setTipoPriority(String tipo, int priority) {
        tipoPriority.put(tipo, priority);
    }

    public String getPreferredTipoForState(int estado) {
